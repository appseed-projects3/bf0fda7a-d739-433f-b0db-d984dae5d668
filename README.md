...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-23 14:19`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/bf0fda7a-d739-433f-b0db-d984dae5d668.git
$ cd bf0fda7a-d739-433f-b0db-d984dae5d668
```
